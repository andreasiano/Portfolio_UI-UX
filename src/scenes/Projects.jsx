      ...
      <div>
        <section>
          <div class="relative xs:max-w-[500px] md:max-w-[1100px] sm:max-w-[900px] xxs:max-w-[360px] mx-auto mb-4 mt-20">
            <img
              class="md:h-[90vh] h-[60vh] sm:h-[50vh] w-full object-cover rounded-md"
              src={img1}
            ></img>
            ...
            <div class="absolute inset-0 flex items-start flex-col justify-center px-6">
              ...
              <h1 class="text-white max-w-[500px] xxs:text-2xl sm:text-3xl md:text-4xl leading-10 font-teko text-5xl mb-2 font-bold">
                TRAVEL MOBILE APP ADVENTURE-VIBES
              </h1>
              <p className="font-sans text-white pb-5 font-regular max-w-[400px] text-[15px] ">
          ...
          <div class="relative xs:max-w-[500px] md:max-w-[1100px] sm:max-w-[900px] xxs:max-w-[360px] mx-auto mb-20 mt-10">
            <img
              class="md:h-[90vh] h-[60vh] sm:h-[70vh] w-full object-cover rounded-md"
              src={img2}
            ></img>
            <div class="absolute inset-0 flex items-start flex-col justify-center px-6">
              <h4 className="font-teko text-gray-400 pb-5 font-regular max-w-[400px] text-[20px] ">
              ...
              <h1 class="text-white xxs:text-2xl sm:text-3xl md:text-4xl max-w-[400px] leading-10 font-teko text-5xl mb-2 font-bold">
